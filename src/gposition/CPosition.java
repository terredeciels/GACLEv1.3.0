...
public final class CPosition {
    ...
    public CPosition(Position position) {
        this.position = position;
        init(position.getFEN());
    }
    ...
    public final void init(final String fen) throws IllegalArgumentException {
        ...
        touslescoups = position.getAllMoves();
...
//    public ArrayList<String> toStringListCPCoups() {
//        ArrayList<String> result = new ArrayList<>();
//        for (short c : touslescoups) {
